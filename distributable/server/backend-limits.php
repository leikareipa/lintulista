...
class BackendLimits
{
    ...
    {
        $this->backendLimits = json_decode(file_get_contents("./metadata/backend-limits.json"), true);
    ...
    //
    // For a list of the property names available, see server/metadata/backend-limits.json.
    //
    function value_of(string $property = "")
    {
        ...
        exit(ReturnObject::failure("Server-side IO failure. Can't find a value for the specified limit."));
    }
}
